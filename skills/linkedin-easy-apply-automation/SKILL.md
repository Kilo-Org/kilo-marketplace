...
description: >-
  Automate LinkedIn Easy Apply searches and applications with
  Puppeteer/Chromium, a verified resume PDF, remote/job-title filtering,
  stateful daily reruns, and conservative answer guardrails.
when_to_use: >-
  Use when you need an AI agent to search LinkedIn jobs and submit LinkedIn Easy
  Apply applications from a verified resume PDF.
license: MIT
metadata:
  supported_agents:
    - claude-code
  ...
  source:
    ...
    path: skills/linkedin-easy-apply-automation
---
