...
name: plugin-scanner
description: >-
  Scan AI agent skills, plugins, MCP servers, and agent tooling for prompt
  injection, unsafe commands, secret exposure, and supply-chain risks before
  installing or trusting them.
metadata:
  ...
  source:
    ...
    ref: main
    commit: 43b2dda59e9f07057c52e69fd7426188faae1488
---
