...
name: using-lwc
description: >-
  Use when substantive project work, structural code questions, research,
  planning, debugging, architecture, decisions, document ingest, incident
  recovery, or verified context and results should survive future sessions; also
  when the user invokes $using-lwc or asks to search, update, repair, configure,
  or maintain an LWC Wiki, physical document graph, or CodeGraph index.
metadata:
  category: development
  author: JanYork
  source:
    repository: 'https://github.com/JanYork/using-lwc'
    path: .
