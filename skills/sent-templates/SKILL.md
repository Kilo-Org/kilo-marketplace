...
name: sent-templates
description: >-
  List, find, inspect, or delete existing Sent templates with the Sent MCP
  tools. Use for direct template records; use waba-template-author to write
  WhatsApp template content and template-builder-ui to design template
  interfaces.
metadata:
  category: development
  source:
    repository: 'https://github.com/sentdm/sent-plugin'
    path: skills/sent-templates
