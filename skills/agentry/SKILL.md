...
name: agentry
description: >-
  Use when the user asks to install, set up, or use Agentry; add analytics,
  logging, error monitoring, deploy attribution, product telemetry, or
...
metadata:
  ...
  author: Agentry
  source:
    repository: 'https://github.com/fr33dr4g0n/agentry-skill'
    path: .
